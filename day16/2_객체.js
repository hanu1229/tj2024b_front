...
console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList);
// 주간 박스오피스의 2번째 영화 정보의 순위
console.log(영화정보.boxOfficeResult.weeklyBoxOfficeList[1].rank);
// 주간 박스오피스의 2번째 영화 정보의 영화명
...
// 2. 무엇을, 영화정보객체
let html = ``;
for(let i = 0; i < 영화정보.boxOfficeResult.weeklyBoxOfficeList.length; i++) {
    let info = 영화정보.boxOfficeResult.weeklyBoxOfficeList[i];
    let audiAcc = Number(info.audiAcc).toLocaleString("ko-KR");
    let salesAcc = Number(info.salesAcc).toLocaleString("ko-KR");
    // console.log(Number(personCount).toLocaleString("ko-KR"));
    html += `<tr>
        <td style = "text-align : center;">${info.rank}</td>
        <td style = "text-align : center;">${info.movieNm}</td>
        <td style = "text-align : center;">${info.openDt}</td>
